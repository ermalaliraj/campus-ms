...
public class HystrixDashboardLauncher extends Launcher {
	...
	private static final transient Logger log = LoggerFactory.getLogger(HystrixDashboardLauncher.class);
	...
	/**
	 * Tries to get the verticle from manifest entry {@code Main-Verticle}, if not found, returns the default one. This
	 * method is make easy develop.
	 *
